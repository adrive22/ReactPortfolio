    ...
    return(
        ...
        <div className="projectContainer">
         <div className="imagesContainer">
            ...
            <p className="test">This React web game uses images stored in a JSON file and shuffles them in random order everytime one of the images is clicked. If you click the same image twice, then you will be alerted and the score will be reset. T
