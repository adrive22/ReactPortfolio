...
function Header () {
  ...
  <MenuMenu position='right'>
      ...
      >
        ...
        className="wordNav">
        <Link
         to="https://drive.google.com/file/d/1_K9Vejhgsj4q1e6mqFsi0y1L4ELtJtEv/view?usp=sharing"
        >
        Résumé
        </Link>
        </MenuItem>
        ...
        <Link to="https://www.linkedin.com/in/allison-driver/">
         ...
         <Dropdown   item icon='bars grey big '>
           <DropdownMenu>
            ...
            href="https://drive.google.com/file/d/1_K9Vejhgsj4q1e6mqFsi0y1L4ELtJtEv/view?usp=sharing">
              Résumé
              </DropdownItem>
              <DropdownItem
               className="dropdownLink" >
